...
# Add parent directory to sys.path so 'bunkr_core' can still be imported as a package
...
def main():
    ...
    parser.add_argument("--no-subdir", action="store_true", help="Do not create album subdirectories")
